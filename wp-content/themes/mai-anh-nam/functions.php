<?php
/**
 * mai anh nam functions and definitions
 *
...
if ( ! function_exists( 'mai_anh_nam_setup' ) ) :
	/**
	 ...
	 */
	function mai_anh_nam_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on mai anh nam, use a find and replace
		 * to change 'mai-anh-nam' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'mai-anh-nam', get_template_directory() . '/languages' );
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__( 'Primary', 'mai-anh-nam' ),
			)
		);
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'mai_anh_nam_custom_background_args',
				array(
...
add_action( 'after_setup_theme', 'mai_anh_nam_setup' );
 ...
 */
function mai_anh_nam_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'mai_anh_nam_content_width', 640 );
}
add_action( 'after_setup_theme', 'mai_anh_nam_content_width', 0 );
 ...
 */
function mai_anh_nam_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'mai-anh-nam' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'mai-anh-nam' ),
...
add_action( 'widgets_init', 'mai_anh_nam_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'mai_anh_nam_scripts' );
